...
| [dispatcher-closed-sweep.md](features/dispatcher-closed-sweep.md) | Dispatcher (`pyrycode/agents`) sweep: closed tickets → Done; orphaned `feature/<N>` branches deleted via GraphQL `deleteRef` |
